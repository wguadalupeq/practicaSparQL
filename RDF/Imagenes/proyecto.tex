...
\subsection{¿Que es la web Semántica?}
...
\end{figure}
\subsection{URLs, URIs, IRIs}
\subsubsection{URLs}
El LRU es una cadena de caracteres con la que se asigna una dirección única a cada uno de los recursos de información disponibles en Internet. Existe un URL único para cada página de la web.
...
\subsection{Buscando RDF con SPARQL}
...
\newpage
Como podemos Apreciar en las figura anteriores es muestra la data ya lista para usarse y pasare a explicar algunas lineas y sea mas fácil para los usuarios que vienen a ser abreviaturas de prefijos para WikiData que es donde hemos bajado la información[h]
