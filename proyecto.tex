...
\subsection{Consultas SPARQL hechas en la esctructura RDF.}

Las siguientes imágenes muestran las capturas de algunas de las consultas hechas a la estructura RDF elegida, en el programa Twinkle. 

\begin{figure}[H]
\includegraphics[scale=0.24]{imagenes/consulta1.jpeg} 
\caption{Mostrar 50 primeras tripletas alamacenadas en la tabla.}
\end{figure} 

\begin{figure}[H]
\includegraphics[scale=0.23]{imagenes/consulta2.jpeg} 
\caption{Mostrar el título, tema y autor si es que tiene 50 obras.}
\end{figure} 

Las capturas de las consultas en su totalidad, se encuentran en la carpeta ./CAPTURAS DE CONSULTAS SPARQL.
